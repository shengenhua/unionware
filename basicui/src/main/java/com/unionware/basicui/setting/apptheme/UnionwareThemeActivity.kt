...
class UnionwareThemeActivity : BaseBindActivity<ActivityAppThemeBinding>() {
    ...
    override fun initData() {
        ...
        themeList.add(UnionwareTheme(-1, "默认主题",
            unionware.base.R.color.mesAppColor))
        themeList.add(
            UnionwareTheme(
                unionware.base.R.style.UnionwareRed,
                "红色主题",
                "#E53935".toColorInt()
            )
        )
        themeList.add(
            UnionwareTheme(
                unionware.base.R.style.UnionwareAzure,
                "天青主题",
                "#00BBFF".toColorInt()
            )
        )
        themeList.add(
            UnionwareTheme(
                unionware.base.R.style.UnionwareGreen,
                "绿色主题",
                "#308033".toColorInt()
            )
        )
