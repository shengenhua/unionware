...
import unionware.base.util.ThemeUtil;
...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ThemeUtil.getColorPrimary(mContext);
//        mDarkColor = ThemeUtil.getColorPrimaryDark(mContext);
//        mLightColor = ContextCompat.getColor(mContext, R.color.mesAppColor);
        mDarkColor = ContextCompat.getColor(mContext, R.color.common_text_dark);
    }
