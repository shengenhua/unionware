...
import com.unionware.once.databinding.AdapterOnceMultiEditItemBinding
...
class EditItemAdapterListener :
    ...
    open class EditItemDataBinding(binding: AdapterOnceMultiEditItemBinding) :
        DataBindingHolder<AdapterOnceMultiEditItemBinding>(binding) {
    ...
    override fun onCreate(
        ...
        return EditItemDataBinding(
            AdapterOnceMultiEditItemBinding.inflate(
