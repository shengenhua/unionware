...
import com.unionware.once.databinding.AdapterOnceScanHeardBinding
import unionware.base.model.bean.barcode.BarCodeBean

class HeardScanAdapter(item: BarCodeBean = BarCodeBean(""), var firstFocusable: Boolean = true) :
    BaseSingleItemAdapter<BarCodeBean, HeardScanAdapter.HeardScanDataBinding>(item) {

    open class HeardScanDataBinding(binding: AdapterOnceScanHeardBinding) :
        DataBindingHolder<AdapterOnceScanHeardBinding>(binding) {
...
//                onEditorActionListener?.onEditor("")
    ...
    override fun onCreateViewHolder(
        ...
        return HeardScanDataBinding(
            AdapterOnceScanHeardBinding.inflate(
