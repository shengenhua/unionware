...
import com.unionware.mes.databinding.AdapterDynamicScanBinding
...
class ScanBarcodeAdapter(item: BarCodeBean = BarCodeBean("")) :
    ...
    open class HeardScanDataBinding(binding: AdapterDynamicScanBinding) :
        DataBindingHolder<AdapterDynamicScanBinding>(binding) {
...
//            this.recyclerView.expandAnimate(false)
    ...
    override fun onCreateViewHolder(
        ...
        return HeardScanDataBinding(
            AdapterDynamicScanBinding.inflate(
