...
import com.unionware.mes.databinding.AdapterDynamicEntryBinding
...
class EntryCollectsAdapter(
    ...
    open class EntryItemDataBinding(binding: AdapterDynamicEntryBinding) :
        DataBindingHolder<AdapterDynamicEntryBinding>(binding) {
    ...
    override fun onCreateViewHolder(
        ...
        return EntryItemDataBinding(
            AdapterDynamicEntryBinding.inflate(
